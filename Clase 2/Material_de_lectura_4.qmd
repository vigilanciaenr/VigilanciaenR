...
Allí tendremos la posibilidad de tomar el código que nos provee R para la importación de datos, dentro de un recuadro que aperece en esta ventana. Un ejemplo de esto:
