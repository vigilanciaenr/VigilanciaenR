...
### 2.2.1. Conversión de estructuras
...
### 2.2.1. Conversión de POSIXct a date
...
### 2.2.3. Conversión de formato de fecha
...
**`Sys.Date()`**: Devuelve la fecha actual en formato **`Date`**.
...
## **2.3. Normalización de caracteres**

### 2.3.1. Modificación de minúsculas y mayúsculas
...
### 2.3.2. Quitar espacios en blanco
...
# write_xlsx(ira, path = "C:/cursor_2024/VigilanciaenR/ira.xlsx")
