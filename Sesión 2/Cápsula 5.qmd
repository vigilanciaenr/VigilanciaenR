...
Esto puede realizarse cuando importamos el dataset o podemos hacerlo una vez que ya lo tenemos importado. Veamos las dos formas.
...
Otra forma de realizarlo es una vez que tenemos el dataset incorporando la función `mutate()` del paquete `dplyr`
...
También puedo querer **cambiar el formato de fecha**, por ejemplo si tengo un valor de fecha como 21/10/2024
