...
Si hay filas presentes en uno y no en el otro (donde no se encontró ninguna coincidencia), el **marco de datos** incluirá las filas  y **se alargará** , rellenando con `NA` los valores faltantes.
:::
...
Para utilizar **`bind_rows()`** debemos tener estructuras similares en nuestro marco de datos para combinarlos luego en uno solo.
