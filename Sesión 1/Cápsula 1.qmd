...
Operadores Matemáticos en R: R se puede usar como una calculador.
...
Veremos sobre todo algunos de ellos para luego ver cómo se utilizan en las funciones.
...
**`edad <- 25 :`** aquí el simbolo **`<-`** se utiliza para asignar un valor a la nueva variable que estoy creando.

**`print(edad):`** Esto se utiliza para imprimir el resultado de la acción de asignación en la consola.
...
Para observar la estructura de los datos que tengo, puedo utilizar la función **`str()`** o **`class()`** para que R me indique que tipo de variables tengo:
...
# Por ejemplo para calcular el área de un rectángulo utilizando las variables
...
Dado un vector podemos estar interesados en obtener datos sobre su contenido y que de algún modo lo resuma.

Si queremos conocer medidas estadísticas de los elementos del vector tenemos las siguientes funciones:
...
-   **median**: nos devuelve la mediana de los elementos del vector.
